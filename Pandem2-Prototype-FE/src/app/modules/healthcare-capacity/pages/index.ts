...
// export * from './bed-occupancy/bed-occupancy.component';
// export * from './emergency/emergency.component';
export * from './human-resources/human-resources.component';
export * from './hospitalizations/hospitalizations.component';
