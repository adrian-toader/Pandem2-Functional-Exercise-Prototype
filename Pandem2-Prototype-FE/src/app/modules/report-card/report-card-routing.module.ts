...
import { AuthManagementGuard } from 'src/app/core/services/guards/auth-management.guard';
...
const routes: Routes = [
  {
    path: 'report-card',
    component: fromPages.ReportCardComponent,
    canActivate: [AuthManagementGuard],
    data: {
      permissions: [PERMISSION.REPORTS_ALL]
    },
