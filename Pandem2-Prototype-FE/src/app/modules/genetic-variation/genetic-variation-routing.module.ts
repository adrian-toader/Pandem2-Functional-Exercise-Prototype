...
const routes: Routes = [
  // Variants
  {
    path: 'high-throughput-sequencing',
    component: fromPages.VariantsComponent,
    canActivate: [AuthManagementGuard],
    data: {
      permissions: [PERMISSION.HIGH_THROUGHPUT_SEQUENCING_ALL]
    },
...
export class GeneticVariationRoutingModule {
}
