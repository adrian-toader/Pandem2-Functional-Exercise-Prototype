...
const routes: Routes = [
  // Vaccination Uptake
  {
    path: 'vaccination-uptake',
    component: fromPages.VaccinationUptakeComponent,
    canActivate: [AuthManagementGuard],
    data: {
      permissions: [PERMISSION.VACCINES_ALL]
    },
    resolve: [UserSettingsResolver]
  }
  // Vaccination Resources
  // {
  //     path: 'vaccination-resources',
  //     component: fromPages.VaccinationResourcesComponent,
  //     canActivate: [AuthManagementGuard],
  // },
  // // Public Response
  // {
  //     path: 'public-response',
  //     component: fromPages.PublicResponseComponent,
  //     canActivate: [AuthManagementGuard],
  // },
];
