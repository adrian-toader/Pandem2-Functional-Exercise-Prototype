...
import { PrimaryCareSubcategories } from 'src/app/core/entities/primaryCare-data.entity';
...
@Component({
  selector: 'app-primary-care-ili-ari-summary-card',
  templateUrl: './primary-care-ili-ari-summary-card.component.html',
  styleUrls: ['./primary-care-ili-ari-summary-card.component.less']
})
export class PrimaryCareILIARICardComponent extends DashboardComponent {
  currentWeekTested = 0;
